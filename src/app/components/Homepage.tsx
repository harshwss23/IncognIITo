...
export function HomePageScreen() {
  ...
  return (
    <div
      className={`w-full h-[100dvh] flex overflow-hidden transition-colors duration-500 relative ${isDark ? "bg-slate-950" : "bg-slate-50"
        }`}
    >
      ...
      >
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div
            className={`absolute -top-20 -left-16 w-56 h-56 rounded-full blur-3xl opacity-20 ${isDark ? "bg-blue-600" : "bg-blue-200"
              }`}
          />
          <div
            className={`absolute bottom-10 -right-10 w-40 h-40 rounded-full blur-3xl opacity-20 ${isDark ? "bg-purple-600" : "bg-purple-200"
              }`}
          />
        </div>
        ...
        {/* Logo */}
        <div
          className={`h-16 md:h-24 flex items-center relative z-10 transition-all duration-300 ${isExpanded ? "px-6 lg:px-8" : "justify-center px-2"
            }`}
        >
          {isExpanded ? (
            <div>
        ...
        <div className={`relative z-10 transition-all duration-300 ${isExpanded ? "px-4 pb-4" : "px-3 pb-4"}`}>
          <button
            ...
            className={`w-full text-left rounded-2xl border transition-all hover:-translate-y-0.5 ${isDark
        ...
        <nav className="flex-1 px-3 md:px-4 space-y-1.5 md:space-y-2 relative z-10 overflow-y-auto no-scrollbar">
          <button
            ...
            className={`w-full flex items-center ${isExpanded ? "justify-between px-4" : "justify-center px-2"
          ...
          >
            <div className="flex items-center gap-3 min-w-0">
              <LayoutGrid
                className={`w-5 h-5 shrink-0 transition-transform group-hover:scale-110 ${activeTab === "home" ? "text-blue-500" : ""
                  }`}
              />
          ...
          {navItems.map((item) => (
            ...
            >
              <div className="flex items-center gap-3 min-w-0">
                <item.icon
                  className={`w-5 h-5 shrink-0 transition-transform group-hover:scale-110 ${activeTab === item.id ? "text-blue-500" : ""
                    }`}
                />
              ...
              {isExpanded &&
                (item.count > 0 ? (
                  ...
                  <ChevronRight
                    className={`w-4 h-4 transition-transform group-hover:translate-x-0.5 ${isDark ? "text-slate-600 group-hover:text-slate-400" : "text-slate-400 group-hover:text-slate-500"
                      }`}
                  />
                ))}
            </button>
        ...
        <div className={`p-4 border-t relative z-10 ${isDark ? "border-white/10" : "border-slate-200"}`}>
          <button
            onClick={logout}
            className={`w-full rounded-xl py-3 flex items-center ${isExpanded ? "justify-center gap-2 px-4" : "justify-center px-2"
      ...
      <div className="flex-1 min-h-0 flex flex-col relative overflow-hidden isolate w-full min-w-0">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div
            className={`absolute top-[-10%] right-[-10%] w-[300px] md:w-[520px] h-[300px] md:h-[520px] rounded-full blur-[80px] md:blur-[120px] opacity-20 ${isDark ? "bg-blue-600/30" : "bg-blue-200"
              }`}
          />
          <div
            className={`absolute bottom-[-10%] left-[5%] w-[250px] md:w-[420px] h-[250px] md:h-[420px] rounded-full blur-[80px] md:blur-[110px] opacity-20 ${isDark ? "bg-purple-600/20" : "bg-purple-200"
              }`}
          />
        </div>
            ...
            <div className="relative z-[100]" ref={menuRef}>
              ...
              {headerMenuOpen && (
                ...
                >
                  ...
                  >
                    <div
                      className={`w-24 h-24 sm:w-32 sm:h-32 rounded-full mb-4 sm:mb-6 shadow-lg ring-4 ${isDark ? "ring-slate-700" : "ring-slate-50"
                        }`}
                    >
                      {user?.avatarUrl || user?.avatar_url || user?.avatar ? (
                        <img
                    ...
                    <p
                      className={`font-extrabold text-lg sm:text-xl text-center truncate w-full ${isDark ? "text-white" : "text-slate-900"
                        }`}
                    >
                      {displayName}
                    </p>
                    <p
                      className={`text-sm sm:text-base text-center truncate w-full mt-1 sm:mt-2 mb-1 sm:mb-2 ${isDark ? "text-slate-400" : "text-slate-500"
                        }`}
                    >
            ...
            <div className="space-y-6 lg:space-y-8 max-w-7xl mx-auto">
              ...
              >
                <div className="absolute inset-0 pointer-events-none">
                  <div
                    className={`absolute top-0 right-0 w-48 h-48 sm:w-72 sm:h-72 rounded-full blur-3xl opacity-25 ${isDark ? "bg-blue-600/30" : "bg-blue-200"
                      }`}
                  />
                  <div
                    className={`absolute bottom-0 left-10 sm:left-20 w-40 h-40 sm:w-60 sm:h-60 rounded-full blur-3xl opacity-20 ${isDark ? "bg-purple-600/25" : "bg-purple-200"
                      }`}
                  />
                </div>
                ...
                <div className="relative z-10 grid grid-cols-1 xl:grid-cols-[1.3fr_0.7fr] gap-8 lg:gap-12 items-center">
                  <div>
                    ...
                    <h1
                      className={`text-3xl sm:text-4xl lg:text-5xl font-black mt-4 sm:mt-5 leading-[1.15] ${isDark ? "text-white" : "text-slate-900"
                        }`}
                    >
                    ...
                    <p
                      className={`text-sm sm:text-base lg:text-lg mt-4 sm:mt-5 leading-relaxed max-w-2xl ${isDark ? "text-slate-400" : "text-slate-600"
                        }`}
                    >
                      {desc}
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 mt-6 sm:mt-8">
                      ...
                      <button
                        ...
                        className={`rounded-2xl px-6 py-3.5 sm:py-4 font-bold border transition-all flex items-center justify-center w-full sm:w-auto ${isDark
              ...
              <div className="grid grid-cols-1 xl:grid-cols-[1.3fr_0.7fr] gap-6">
                <div
                  className={`rounded-3xl border p-5 sm:p-6 shadow-sm ${isDark ? "bg-slate-900/40 border-white/10" : "bg-white border-slate-200"
                    }`}
                >
            ...
            <div className="space-y-6 max-w-5xl mx-auto">
              ...
              >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-6 lg:gap-8 mt-6 sm:mt-8">
                  ...
                  <div
                    className={`rounded-3xl border p-5 sm:p-6 ${isDark ? "bg-white/5 border-white/10" : "bg-slate-50 border-slate-200"
                      }`}
                  >
                    <h3 className={`text-lg sm:text-xl font-bold ${isDark ? "text-white" : "text-slate-900"}`}>
                      Ready to proceed?
...
function MetricCard({ isDark, icon: Icon, title, value, sub }: any) {
  return (
    <div
      className={`rounded-2xl border p-4 sm:p-5 transition-all ${isDark ? "bg-slate-900/40 border-white/10 hover:bg-slate-800" : "bg-white border-slate-200 hover:shadow-md"
        }`}
    >
      <div className="flex items-center justify-between">
        <div
          className={`w-10 h-10 sm:w-11 sm:h-11 rounded-xl flex items-center justify-center shrink-0 ${isDark ? "bg-white/5" : "bg-slate-100"
            }`}
        >
...
function StatGlassCard({ isDark, icon: Icon, value, label }: any) {
  return (
    <div
      className={`rounded-2xl border p-4 sm:p-5 backdrop-blur-md transition-all hover:-translate-y-0.5 ${isDark ? "bg-white/5 border-white/10 hover:bg-white/10" : "bg-white/80 border-slate-200 hover:shadow-md hover:bg-white"
        }`}
    >
      <div className="flex items-center gap-3 sm:gap-4">
        <div
          className={`w-10 h-10 sm:w-12 sm:h-12 shrink-0 rounded-2xl flex items-center justify-center ${isDark ? "bg-gradient-to-br from-blue-600 to-purple-600 shadow-inner" : "bg-gradient-to-br from-blue-500 to-indigo-500 shadow-sm"
            }`}
        >
          <Icon className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
        </div>
...
function QuickActionButton({ isDark, icon: Icon, label, onClick }: any) {
  return (
    ...
    >
      <div className="flex items-center gap-3 min-w-0">
        <div
          className={`w-8 h-8 sm:w-10 sm:h-10 shrink-0 rounded-xl flex items-center justify-center transition-colors ${isDark ? "bg-white/5 group-hover:bg-blue-500/20" : "bg-white group-hover:bg-blue-50 shadow-sm"
            }`}
        >
          <Icon className="w-4 h-4 sm:w-5 sm:h-5 text-blue-500" />
        </div>
...
function SmallInfoCard({ isDark, title, value }: any) {
  return (
    <div
      className={`rounded-2xl border p-3 sm:p-4 transition-colors ${isDark ? "bg-slate-900/50 border-white/10 hover:bg-slate-800" : "bg-white border-slate-200 hover:bg-slate-50"
        }`}
    >
