...
export function OTPVerificationScreen() {
  ...
  return (
    ...
    <div
      className={`min-h-[100dvh] w-full flex flex-col p-4 sm:p-8 transition-colors duration-500 overflow-y-auto no-scrollbar ${theme === 'dark' ? 'bg-[#020617]' : 'bg-slate-50'
        }`}
    >
      ...
      <div
        className={`w-full max-w-[550px] min-h-[600px] sm:min-h-[800px] mx-auto shrink-0 ${theme === 'dark'
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden rounded-[inherit]">
          <div
            className={`absolute top-[20%] left-1/2 -translate-x-1/2 w-64 h-64 sm:w-96 sm:h-96 ${theme === 'dark' ? 'bg-blue-500/20' : 'bg-blue-400/15'
              } rounded-full blur-[80px] sm:blur-[100px] animate-pulse mix-blend-screen`}
          />
          <div
            className={`absolute bottom-[20%] left-1/2 -translate-x-1/2 w-48 h-48 sm:w-64 sm:h-64 ${theme === 'dark' ? 'bg-purple-500/15' : 'bg-purple-400/10'
        ...
        <div className="relative z-10 w-full max-w-md space-y-10 sm:space-y-12 py-8">
          ...
          <div className="text-center space-y-5 sm:space-y-6">
            ...
            <div className="space-y-3">
              <h2
                className={`text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight ${theme === 'dark' ? 'text-white' : 'text-slate-900'
                  }`}
              >
                Forgot Password
              </h2>
              ...
              <div
                className={`flex items-center justify-center gap-2 ${theme === 'dark' ? 'text-blue-400' : 'text-blue-600'
                  }`}
              >
            ...
            <div className="flex justify-between sm:justify-center gap-2 sm:gap-3">
              {otp.map((digit, index) => (
                <input
                  ...
                  className={`w-12 h-14 sm:w-14 sm:h-16 md:w-16 md:h-20 ${theme === 'dark'
