...
// POST /api/match/rate   → Rate the user you just chatted with
router.post('/rate', authMiddleware.authenticate.bind(authMiddleware), matchController.rateUser.bind(matchController));
